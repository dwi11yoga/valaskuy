...
<body class="flex flex-col min-h-screen">
    ...
    <nav class="bg-white shadow-sm flex items-center justify-between px-10 py-6 sticky top-0 z-50">
        ...
        <div class="">
            <ul class="flex space-x-8">
                <li>
                    <a href="/"
                        class="text-gray-700 hover:text-blue-500 {{ $title == 'Selamat datang di ValasKuy!' ? 'font-bold navbar-selected px-2 rounded-sm' : '' }}">
                        Hitung Valas
                    </a>
                </li>
                <li>
                    <a href="/"
                        class="text-gray-700 hover:text-blue-500 {{ $title == 'Daftar Kurs' ? 'font-bold navbar-selected px-2 rounded-sm' : '' }}">
                        Daftar Kurs
                    </a>
                </li>
                <li>
    ...
    {{-- konten --}}
    <main class="container mx-auto p-10 grow">
        @yield('content')
    </main>

    {{-- footer --}}
    <footer class="bg-white flex justify-between items-center px-10 py-6 sticky top-0 z-50"
